  ...
  const hardware_interface::HardwareInfo & info)
{
  ...
  wheel_lb_.setup(cfg_.left_back_wheel_name, cfg_.enc_counts_per_rev);
  wheel_lf_.setup(cfg_.left_front_wheel_name, cfg_.enc_counts_per_rev);
  wheel_rb_.setup(cfg_.right_back_wheel_name, cfg_.enc_counts_per_rev);
  ...
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  ...
  comms_.set_motor_values(motor_lb_counts_per_loop, motor_rb_counts_per_loop);
  comms_.set_motor_values(motor_lf_counts_per_loop, motor_rf_counts_per_loop);
  return hardware_interface::return_type::OK;
}
