...
void subscription_callback(const void * msgin)
{
  ...
  int angle = msg->data; // Get angle value from message
...
void setup() {
  ...
  servo.attach(SERVO_PIN,544,2600); // Attach servo to pin 12
  ...
  RCCHECK(rclc_subscription_init_default(
    &subscriber,
    &node,
    ROSIDL_GET_MSG_TYPE_SUPPORT(std_msgs, msg, Int32), // Changed to UInt16
    "/servo"));
  ...
  range_msg.range = 0.01; // Initial range value
}
